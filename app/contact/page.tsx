    ...
    <section className="py-16">
      <Container className="py-8">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 mt-10">
          {/* Contact Information */}
          <div>
            <h3 className="text-2xl font-serif font-medium text-timber-dark mb-6">Get In Touch</h3>
            
            <div className="space-y-6">
              <div className="flex items-start gap-4">
                <div className="rounded-full bg-timber-light/30 p-3 text-timber-dark">
                  <svg xmlns="http://www.w3.org/2000/svg" className="h-6 w-6" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M3 5a2 2 0 012-2h3.28a1 1 0 01.948.684l1.498 4.493a1 1 0 01-.502 1.21l-2.257 1.13a11.042 11.042 0 005.516 5.516l1.13-2.257a1 1 0 011.21-.502l4.493 1.498a1 1 0 01.684.949V19a2 2 0 01-2 2h-1C9.716 21 3 14.284 3 6V5z" />
                  </svg>
                </div>
                <div>
                  <h4 className="text-lg font-medium text-timber-dark">Phone</h4>
              ...
              <div className="flex items-start gap-4">
                ...
                <div>
                  <h4 className="text-lg font-medium text-timber-dark">Email</h4>
                  <p className="text-muted-foreground mt-1">info@timberelegance.com</p>
              ...
              <div className="flex items-start gap-4">
                ...
                <div>
                  <h4 className="text-lg font-medium text-timber-dark">Office</h4>
                  <p className="text-muted-foreground mt-1">123 Timber Lane</p>
            ...
            <div className="mt-10">
              <h3 className="text-2xl font-serif font-medium text-timber-dark mb-4">Follow Us</h3>
              <div className="flex gap-4">
                <a href="#" className="bg-timber-light/30 hover:bg-timber-light text-timber-dark p-3 rounded-full transition-colors">
          ...
          <div className="bg-white p-8 rounded-lg shadow-sm">
            ...
            <form onSubmit={handleSubmit} className="space-y-4">
              ...
              <button
                ...
                className="w-full bg-timber-dark hover:bg-timber-dark/90 text-white py-3 rounded-md font-medium transition-colors disabled:opacity-70"
              >
